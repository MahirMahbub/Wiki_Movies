...
class DBHandler(AbstractHandler):
    def execute(self, request_data: List[Dict[Any, Any]]) -> bool:
        ...
        for idx, movies_basic in enumerate(movies_basic_list):
            ...
            movie_basic_schema = MovieCreate(film_name=movies_basic.get("Film", ""),
            ...
            for attr in attributes_list:
                attr_data_list = movies_details[attr]
                for attr_data in attr_data_list:
                    attr_data_schema = MovieDetailCreate(property_name=attr,
